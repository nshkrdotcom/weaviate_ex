defmodule WeaviateEx.API.Vectorizers.Multi2VecVoyageAI do
  @moduledoc """
  ...
  def vectorizer_name, do: "multi2vec-voyageai"
  ...
  """
  @spec from_api(map()) :: t()
  def from_api(%{"moduleConfig" => %{"multi2vec-voyageai" => config}}) do
    %__MODULE__{
